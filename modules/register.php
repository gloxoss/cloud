...
<head>
    ...
    <title>Register - CloudStorageX</title>
</head>

<body>
    <header class="header--page" id="home" style="position : relative ; margin-top : 0">
        <nav  style="position : relative ; margin : 0 !important;" class="navbar navbar-dark navbar-expand-md bg-faded justify-content-center fixed-top" data-toggle="affix">
            <div class="container">
                <a href="/cloud" class="navbar-brand d-flex mr-auto" style="color :white; margin-top :-100px">CloudStorageX</a>
            </div>
        </nav>
    </header>
    <div class="body--page" style="margin-top: 150px;">
        <div class="container">
            <div class="row">
