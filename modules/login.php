...
<head>
    ...
    <title>Login - CloudStorageX</title>
</head>

<body>
    <header class="header--page" id="home" style="margin-bottom: 100px;">
        <nav class="navbar navbar-dark navbar-expand-md bg-faded justify-content-center fixed-top" style="position: relative;"data-toggle="affix">
            <div class="container">
                <a href="/cloud" class="navbar-brand d-flex mr-auto" style="color : white; margin-top :-100px">CloudStorageX</a>
            </div>
        </nav>
    </header>
    <div class="body--page" style="margin-top: 150px !important;">
        <div class="container">
            <div class="row">
