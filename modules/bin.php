...
$file_list = getBinFiles($_SESSION['id'], $offset);
?>
...
<div class="col-md-6">
    <div class="file-box">
        ...
        <div class="file-link sc-text-color">
            <a href="http://CloudStorageX.us/d.php?<?php echo $file[1]; ?>" id="file-link">http://CloudStorageX.us/d.php?<?php echo $file[1]; ?></a><i class="far fa-copy" onclick="copyToClipboard('#file-link')" data-toggle="tooltip"></i>
        </div>
        <form class="deleteForm" method="post" action="delete.php">
            <button class="btn file-delete-link" type="submit" id="fileShortlink" name="file" value="<?php echo $file[1]; ?>">Delete permanantly</button>
        </form>
        <form class="recoverForm" method="post" action="recover.php" >
            <button class="btn file-delete-link" type="submit" id="fileShortlink" name="file" value="<?php echo $file[1]; ?>">Recover file</button>
        </form>
    </div>
</div>
<?php endforeach; ?>
...
$user_limit = getUserPlan($_SESSION['id'])[1];
?>
