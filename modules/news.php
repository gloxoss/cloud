...
<head>
    ...
    <title>News - CloudStorageX</title>
</head>
...
<body>
    <header class="header--page" id="home">
        <nav class="navbar navbar-dark navbar-expand-md bg-faded justify-content-center fixed-top" data-toggle="affix">
            <div class="container">
                <a href="dashboard.php" class="navbar-brand d-flex mr-auto">CloudStorageX</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 news">
                    <div id="wrap">
                        <div class="card--news">
                            <div class="card-top card-top-with-content">
                                <div class="news-title-block">
                                    <h1>1 Critical and Non-Critical Updates</h1>
                                    <span class="news-date">April 15th, 2018</span>
                                </div>
                        ...
                        <div class="card--news">
                            <div class="card-top card-only-title">
                                <h1>2 News with only a title</h1>
                                <span class="news-date">April 15th, 2018</span>
                            </div>
                        </div>
                        <div class="card--news">
                            <div class="card-top card-top-with-content">
                                <div class="news-title-block">
                                    <h1>3 Critical and Non-Critical Updates</h1>
                                    <span class="news-date">April 15th, 2018</span>
                                </div>
                                <i class="fas fa-plus"></i>
                            </div>
                        ...
                        <div class="card--news">
                            <div class="card-top card-top-with-content">
                                <div class="news-title-block">
                                    <h1>4 Critical and Non-Critical Updates</h1>
                                    <span class="news-date">April 15th, 2018</span>
                                </div>
                                <i class="fas fa-plus"></i>
                            </div>
                            <div class="card-body">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent eget ullamcorper erat. Quisque mollis pellentesque arcu convallis auctor. Donec in ligula sed risus semper ultrices non vitae magna. Curabitur ac nisl fringilla, ullamcorper mi ac, maximus mauris. Proin bibendum erat lectus, non sagittis tortor porttitor eget. Phasellus vestibulum nisl sed maximus eleifend. Donec dui enim, vehicula vitae justo et, mollis ornare lectus. Donec vulputate lorem amaximus tempor. Quisque fringilla quis dui eu luctus. Vivamus condimentum nisi id placerat feugiat.</p>
                            </div>
                        </div>
                        <div class="card--news">
                            <div class="card-top card-top-with-content">
                                <div class="news-title-block">
                                    <h1>5 Critical and Non-Critical Updates</h1>
                                    <span class="news-date">April 15th, 2018</span>
                                </div>
                                <i class="fas fa-plus"></i>
                            </div>
                        ...
                        <div class="card--news">
                            <div class="card-top card-top-with-content">
                                <div class="news-title-block">
                                    <h1>6 Critical and Non-Critical Updates</h1>
                                    <span class="news-date">April 15th, 2018</span>
                                </div>
                                <i class="fas fa-plus"></i>
                            </div>
...
?>
    ...
    <script>
    var count = $("#wrap > .card--news").length;
    var perPage = 4;
    ...
    if (totalPages > 1) {
        ...
        for (i = 0; i < count; i += perPage) {
            if (i == 0) {
                $("#wrap > .card--news").slice(i,i+perPage).addClass('page' + (i + perPage) / perPage);
            } else {
                $("#wrap > .card--news").slice(i,i+perPage).addClass('page' + (i + perPage) / perPage).hide();
            }
        }
        $('.next').on('click',function(){
            if (page < totalPages) {
        	    $("#wrap > .card--news:visible").hide();
                $('.page' + ++page).show();
    ...
    <script>
        ...
        var acc = document.getElementsByClassName("card-top-with-content");
        var i;
