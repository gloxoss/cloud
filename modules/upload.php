...
<head>
    ...
    <title>Upload - CloudStorageX</title>
</head>
                ...
                <div class="col-md-8">
                    ...
                    <div class="card-body">
                        <form action="processupload.php" id="fileForm" enctype="multipart/form-data" class="dropzone">
                            ...
                            ?>
                            <input type="submit" value="upload" id="uploadBtn" class="btn sc-btn-gradient sc-shadow sc-shadow-hover">
                        </form>
...
?>
                        ...
                        <div class="progress-bar" role="progressbar" style="width: <?php echo ($user_limit > 0 ? ($all_file_size / $user_limit) * 100 : 0); ?>%" aria-valuenow="1" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    </div>
                </div>
            </div>
